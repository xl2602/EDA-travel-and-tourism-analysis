...
Based on the nature of our dataset, the aspects of data quality we care about most are: 1) inconsistent presentation of categorical variables; 2) Missing values, so we will break data quality down to these two parts and discuss separately.

### i. Inconsistent Presentation of Categorical Values
