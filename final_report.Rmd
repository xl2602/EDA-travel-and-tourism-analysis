...
In order to analyze data quality of our data, we need first to take a look at each of them. And we truncat the output for a more compact look in report.
<br>
<br>
...
* Country and region mized together
* Missing values
...
Since the our data is very messy, we put many effort on cleaning and extract useful infomation from it. Our data cleaning can be summarized into two parts:

1. Conqure all the data quality issues mention in privous session.
...
2. Combine/Join some data togetgher to make further visualization easier. 
